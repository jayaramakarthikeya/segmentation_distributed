...
class HighResolutionNet(BaseModel):
    ...
    def __init__(self, num_classes=150, **kwargs):
        ...
        self.stage2, pre_stage_channels = self._make_stage(
            num_modules=1,num_branches=2,num_blocks=[4,4],num_channels=[32,64],block=block,fuse_method='SUM', num_inchannels=num_channels)
        ...
        self.stage3, pre_stage_channels = self._make_stage(
            num_modules=1,num_branches=3,num_blocks=[4,4,4],num_channels=[32,64,128],block=block,fuse_method='SUM', num_inchannels=num_channels)
